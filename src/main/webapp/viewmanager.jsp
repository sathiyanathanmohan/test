...
function goBack() {
	...
	<table width="1000px" align="center" cellspacing="0" cellpadding="0">
		<tbody>
			...
			<tr>
				<td><label id="employeecode"></label> <label id="employeename"></label>
					<label id="designation"></label></td>
			</tr>


			<tr>
				<td><label id="employeecodecombo">Employee Code*</label> <select
					id="selectcombo">
						<option value="Select">Select</option>
				</select> <label id="startdatel">Start Date*</label> <input type="date"
					id="startdate" value=""> <label id="enddatel">End
						Date*</label> <input type="date" id="enddate" value="">
					<button id="viewtimesheet">
						<B>View Timesheet</B>
					</button></td>
			</tr>
			...
			<tr>
				<td>
					<div id="timesheetdiv">
						<p id="timesheettitle">Time Approved</p>
					</div>
				</td>
			</tr>
			<tr>
		...
		<td>
			...
			<div id="myModal" class="modal">
				...
				<div class="modal-content">
					...
					<h4>Employee Code:</h4>
					<label id="emp_code1"></label>
					<h4 Style="margin-left: 20px">Employee Name:</h4>
					<label id="emp_name1"></label>
					<h4 Style="margin-left: 30px">Total Working Hours:</h4>
					<label id="day_hours1"></label>
					<div id="dailydiv"
						Style="position: relative; margin-left: 2px; width: 1000px;">
						<p id="dailytitle">Detail Daily Timesheet</p>
					</div>

					<table Style="position: relative; margin-top: 8px; width: 1000px;"
						border="1">
						<tr>
							<th>Sequence No
							<th>Project Code</th>
