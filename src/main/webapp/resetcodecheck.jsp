...
%>
	...
	<table width="450px" align="center" cellspacing="0" cellpadding="0">
		<tbody>
			...
			<tr>
				<td><label id="userid"><b>USER ID:</b><b
						Style="color: #5533ff"> <%=emp_code.toUpperCase()%></b></label> <%-- <td align="left"><h2 id="welcomeuser" ALIGN="left">USER ID:<%=emp_code.toUpperCase()%> </h2> --%>
				</td>
			</tr>
			<tr>
				<td>
					<div id="passworddiv">
						<p id="passwordtitle" Style="color: white">Reset Password Page</p>
					</div>
				</td>
			</tr>
			<tr>
				<td><input type="hidden" id="empcode" value="<%=emp_code%>">
					<div id="newpassworddiv">
						<label id="newpasswordl"><b>Create New Password :</b></label> <input
							id="newpassword" maxlength="50" name="username" type="password" />
						<br> <br> <label id="confirmnewpasswordl"><b>Confirm
								New Password :</b></label> <input id="confirmnewpassword" maxlength="50"
