...
<script type="text/javascript"
	src="ProjectManagementTool-UI/js/project_view.js"></script>
<script src="ProjectManagementTool-UI/js/cookies.js"></script>
<link rel="stylesheet" type="text/css"
	href="ProjectManagementTool-UI/css/overallview.css">
	...
	<table width="1002px" align="center">
		...
		<tbody>
			...
			<tr>
				<td>
					<div id="projectdiv">
						<p id="projecttitle" Style="color: white">Project View</p>
					</div>
				</td>
			</tr>
						...
						<form id="form" method="post">
							...
							<div style="margin-right: 2px">
								<fieldset id="projectdetails">
									...
									<label>Project Code</label> <input id="projectcode"
										readOnly="readonly" maxlength="10" name="projectcode"
										type="text" /> <br> <label>Project Name</label> <input
										id="projectname" readOnly="readonly" maxlength="50"
										name="projectname" type="text" /> <br> <label>Start
										Date</label> <input id="startdate" readOnly="readonly" maxlength="20"
										name="startdate" type="date" /> <br> <label>End
										Date</label> <input id="enddate" readOnly="readonly" maxlength="20"
										name="enddate" type="date" /> <br> <br> <label
										id="pdl">Project Description</label>
									<textarea id="pd" readOnly="readonly" name="pd" rows="4"
										cols="50"></textarea>
								</fieldset>
							</div>
							...
							<div style="margin-right: 2px">
								<fieldset id="developementdetails">
									...
									<label>Center</label> <input id="center" readOnly="readonly"
										name="projectcode" type="text" /> <br> <label>Location</label>
									<input id="location" readOnly="readonly" name="projectcode"
										type="text" /> <br> <label>Contract Type</label> <input
										id="contracttype" readOnly="readonly" name="projectcode"
										type="text" /> <br> <label>Project Status</label> <input
										id="projectstatus" readOnly="readonly" name="projectcode"
										type="text" /> <br> <label>Customer Portfolio</label> <input
										id="customerportfolio" readOnly="readonly" name="projectcode"
										type="text" /> <label id="servicesl">Services Offered</label>
									<input id="services" readOnly="readonly" name="projectcode"
										type="text" /> <label id="techl">Technology</label>
									<!--          <input  id="technology"  name="projectcode" type="text" /> -->



									<textarea readOnly="readonly" id="tech" rows="4" cols="50"
										name="tech"> </textarea>
									<label id="effortl">Effort Required</label> <input
										readOnly="readonly" id="effortrequired" maxlength="50"
										name="effortrequired" type="text" /> <label id="mandays">Man-days</label>


									<label id="onsitel">Onsite</label> <input id="onsite"
										name="onsite" readOnly="readonly" maxlength="50" name="name"
										type="text" /> <label id="offshorel">offshore</label> <input
										id="offshore" readOnly="readonly" name="offshore"
										maxlength="50" name="name" type="text" />
							...
							<div style="margin-right: 2px">
								<fieldset id="customerdetails">
									...
									<label>Cilent Name :</label> <input id="cc" readOnly="readonly"
										name="customername" type="text" /> <label id="customercode"></label>
							...
							<div style="margin-right: 2px; margin-left: 2px">
								<fieldset id="responsibility">
									...
									<label id="deliverymanagerl">Delivery Manager</label> <input
										id="deliverymanager" readOnly="readonly" name="projectcode"
										type="text" /> <label id="onsitecoordinatorl">Onsite
										Co-ordinator</label> <input id="onsitecoordinator" readOnly="readonly"
							...
							<div style="margin-right: 2px; position: relative">
								<div>
									<fieldset id="remarks">
										...
										<textarea id="general" name="general" readOnly="readonly"
								...
								<div>
									<fieldset id="supportfile">
										...
										<label Style="position: absolute; margin-top: 15px"
											id="uploadfile">Upload Files</label><br> <input
											Style="position: absolute; margin-top: 35px; margin-left: 30%; width: 130px; height: 30px; background-color: #0078D7; color: white;"
											type="button" value="View attached files"
											onclick='onclick1()'> <br>
							...
							<div style="margin-right: 2px">
								<fieldset id="allocationdetails">
									<legend>
										<label><b>Project Allocation Details</b></label>
									</legend>
									<table class="display" id="example"
										style="cellspacing: 0; width: 99.8%; margin-left: 0px; margin-right: 0.1%;">
							...
							<button id="exit" type="button" onclick="close1()">
								<b>Exit</b>
							</button>
