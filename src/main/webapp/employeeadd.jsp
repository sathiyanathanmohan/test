...
<script src="ProjectManagementTool-UI/js/Employee_add.js"></script>
<style>
input[type="text"] {
	...
	<table width="1000px" align="center" cellspacing="0" cellpadding="0">
		<tbody>
			...
			<tr>
				<td>
					<div id="customerdiv">
						<p id="customertitle">Employee Add</p>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					...
					<form id="form">
						<div id="overalldiv" style="border: 1px solid black;">
							...
							<p align="center" style="width: 650px;">
								<label></label>
							</p>
							<h3 style="border-left-width: 0px; margin-left: 149px;">
								EMPLOYEE CODE * :&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
									onkeypress="return alphanumber(event)" id="emp_code"
									name="emp_code" style="width: 316px; height: 29px;">
							</h3>
							<p></p>
							...
							<h3 style="margin-left: 144px;">
								EMPLOYEE NAME * :&nbsp;&nbsp;&nbsp;&nbsp; <input
									onkeypress="return onlyAlphabets(event)" type="text"
									id="emp_name" name="emp_name"
									style="width: 316px; height: 27px;">
							</h3>
							<p></p>
							<p align="justify" style="width: 583px;">
								<label></label>
							</p>
							...
							<button id="save" style="margin-left: 360px; margin-top: 8px;">
								<b>Save</b>
							</button>
