...
<tr>
<td>
<div id="customerdiv"><p id="customertitle">Employee Add</p></div>
</td>
</tr>
<tr>
<td>
...
<p align="center" style="width: 650px; "><label></label></p><h3 style="
    border-left-width: 0px;
    margin-left: 149px;
">EMPLOYEE CODE  * :&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" onkeypress="return alphanumber(event)"  id="emp_code" name="emp_code" style="width: 316px;height: 29px;"></h3>   <p></p>

<p align="justify" style="width: 650px; "><label></label></p><h3 style="
    margin-left: 144px;
">EMPLOYEE NAME  * :&nbsp;&nbsp;&nbsp;&nbsp; <input  onkeypress="return onlyAlphabets(event)" type="text" id="emp_name" name="emp_name" style="width: 316px;height: 27px;"></h3>   <p></p>
<p align="justify" style="width: 583px; "><label></label></p><h3 style="height: 44px;width: 534px;margin-left: 180px;">DESIGNATION * : &nbsp;&nbsp;&nbsp;&nbsp;<select id="emp_design" name="emp_design" style="
 width: 319px;
...
<p align="justify" style="width: 518px; "><label></label></p><h3 style="
    border-left-width: 0px;
    margin-left: 210px;
">E -MAIL ID  * :&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" id="emp_mail" name="emp_mail" style="width: 320px;height: 26px;"></h3>   <p></p>
