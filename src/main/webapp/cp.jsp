...
<body>
	<table width="600px" align="center" cellspacing="0" cellpadding="0">
		...
		<tbody>
			<tr>
				<td colspan="2">
					<h2 id="welcomeuser" align="left"></h2>
					<button id="logout">
						<b>Log Out</b>
					</button> <img id="back"
			...
			<tr>
				<td colspan="2"><div id="timesheetdiv">
						<p id="timesheettitle"">Changepassword</p>
					</div></td>
			</tr>
				...
				<td>
					<div id="all">
						<form id="form" method="post">
							...
							<div>
								<label id="l1">Old Password*</label> <input name="OldPassword"
									type="password" id="OLDpwd">
							</div>
							<div>
								<label id="l2">NewPassword*</label> <input name="newpassword"
									type="password" id="newpassword">
							</div>
							<div>
								<label id="l3">Confirm Password*</label> <input
									name="conpassword" type="password" id="conpassword">
							</div>
							<div>
