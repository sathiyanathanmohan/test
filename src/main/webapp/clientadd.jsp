...
function goBack() {
	...
	<table width="1000px" align="center" cellspacing="0" cellpadding="0">
		<tbody>
			<tr>
				<td><label id="welcomeuser" style="width: 550px;"><b></b></label>
					<button id="logout">
						<B>Log Out</B>
			...
			<tr>
				<td>
					<div id="customerdiv">
						<p id="customertitle">Client Add</p>
					</div>
				</td>
			</tr>
			<tr>
							...
							<div>
								<fieldset
									...
									<label id="ecc"> Enter Client Code</label> <label id="ecn">
										...
										id="areacode" maxlength="5" placeholder="+91" name="areacode"
										type="text" /> <input id="phoneno" maxlength="10"
										name="phoneno" type="text" /> <label id="ecw"> Enter
										Company Website </label> <label id="eac">Enter areacode</label> <label
										id="epno">Enter phone number</label>
