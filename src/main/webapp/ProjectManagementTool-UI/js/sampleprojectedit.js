...
$().ready(function(){
	...
	$("#save").click(function (event){
		var projectcode=$('#projectcode').val();alert(projectcode);
		var projectname=$('#projectname').val();
		var effortrequired=$('#effortrequired').val();
		var onsite=$('#onsite').val();
		var offshore=$('#offshore').val();
...
alert(projectcode);
if(projectcode!=null&&projectname!=null&&center!='Select'&&location!='Select'&&contracttype!='Select'&&customerportfolio!='Select'&&services!='Select'&&projectmanager!='Select'&&deliverymanager!='Select'&&onsitecoordinator!='Select'&&valid2==1&&valid3==1&&valid4==1&&valid5==1)
{
...
if(center!='Select'&&location!='Select'&&contracttype!='Select'&&customerportfolio!='Select'&&services!='Select'&&projectmanager!='Select'&&deliverymanager!='Select'&&onsitecoordinator!='Select'&&valid2==1&&valid3==1&&valid4==1&&valid5==1)
{
//var myform = document.getElementById("form");
	var url = "rest/webservices/editproject";
var data = $("#form").serialize();
