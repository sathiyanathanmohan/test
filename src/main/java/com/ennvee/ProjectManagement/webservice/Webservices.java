...
public class Webservices {
	...
	//@Consumes(MediaType.MULTIPART_FORM_DATA)
	//@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	public String report2( @QueryParam("cus_code") String cus_code
		...
		try {
			...
			array = datahandler.reportclient(cus_code);
	...
	//@Consumes(MediaType.MULTIPART_FORM_DATA)
	//@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	public String report3( @QueryParam("pro_id") String pro_id,@QueryParam("cus_code") String cus_code
		...
		try {
			...
			array = datahandler.reportclientview(pro_id,cus_code);
	...
	//		DataHandler dataHandler = new DataHandler(); 
	//		
	//		timelist=dataHandler.get_timesheetall(start_date,end_date);
	//		
	//		if (timelist != null
	//				&&timelist.size() > 0) {
	//			status = 0;
	...
	@GET
	@Path("/project_managername")
	@Produces(MediaType.APPLICATION_JSON)
	//@Consumes(MediaType.MULTIPART_FORM_DATA)
	//@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	public String projectmanagername( @QueryParam("emp_code") String emp_code
		...
		try {
			...
			array = datahandler.projectmanagername(emp_code);
