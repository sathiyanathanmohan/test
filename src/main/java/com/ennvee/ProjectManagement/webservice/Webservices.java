...
public String createproject( @FormParam("projectcode") String project_code,
		...
		@FormParam("onsite") String onsite,
		@FormParam("offshore") String offshore,
		...
		@FormParam("general") String general,@FormParam("filedescr") String file_description,
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		...
		if (allocationList != null
				&& allocationList.size() > 0) {
			status = 0;
			Gson gson = new Gson();
			JsonElement element = gson.toJsonTree(allocationList,
					new TypeToken<List<Allocationobject>>() {
					}.getType());
	...
	System.out.println("Result returned from get_allocation():"
			+ jsonResult);
...
//@Consumes(MediaType.MULTIPART_FORM_DATA)
@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
public String editproject(  @FormParam("id") int id,@FormParam("projectcode") String project_code,
		@FormParam("projectname") String project_name,
		@FormParam("pd") String project_description ,
		@FormParam("center") String center,
		@FormParam("startdate")String start_date,
	...
	try {
		...
		String logg=log.log(Models.getprojectObject(),Models.getoldprojectObject(),updated_by,updated_place,updated_id);	
...
public String update_allocation(
		@FormParam("eemp_id") String emp_code,
...
public String get_allproject()
{
	...
	try {
		...
		if (proList != null
			...
			JsonElement element = gson.toJsonTree(proList,
					new TypeToken<List<ProjectObject>>() {
					}.getType());
	...
	System.out.println("**********************************************************************");
	System.out.println("Result returned from get_allproject():"
			+ jsonResult);
	System.out.println("**********************************************************************");
...
public String  get_allemployee(@QueryParam("designation") String designation)
{
	...
	try {
		...
		if (empList != null
			...
			JsonElement element = gson.toJsonTree(empList,
					new TypeToken<List<Employeobject>>() {
					}.getType());
	...
	System.out.println("Result returned from get_allemployee1():"
			+ jsonResult);
	System.out.println("**********************************************************************");
	...
	try {
		...
		if (loginList != null
			...
			JsonElement element = gson.toJsonTree(loginList,
					new TypeToken<List<LoginObject>>() {
					}.getType());
...
//	System.out.println("**********************************************************************");
	System.out.println("Result returned from get_getlogin():"
			+ jsonResult);
//	System.out.println("**********************************************************************");
	return jsonResult.toString();
...
public String  get_employee_login( )
{
	...
	System.out.println("Result returned from get_employee_login( ):"
			+ jsonResult);
	System.out.println("**********************************************************************");
...
//@Consumes(MediaType.MULTIPART_FORM_DATA)
@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
public String updatepass(  @FormParam("id") String id,@FormParam("newpassword") String project_code) {
...
public String get_allcustomerdetails(){
	...
	System.out.println("**********************************************************************");
	System.out.println("Result returned from getcustomerdeatils():"
			+ jsonResult);
	System.out.println("**********************************************************************");
	...
	try {
		...
		if (masterList != null
			...
			JsonElement element = gson.toJsonTree(masterList,
					new TypeToken<List<MasterObject>>() {
					}.getType());
...
//	System.out.println("**********************************************************************");
	System.out.println("Result returned from get_masterdetails():"
			+ jsonResult);
//	System.out.println("**********************************************************************");
	return jsonResult.toString();
...
JsonObject jsonResult = new JsonObject();
	...
	System.out.println("Result returned from get_oneallocation():"
			+ jsonResult);
...
public String get_projectdetails(@QueryParam("id") int id)
{
	...
	System.out.println("Result returned from get_project():"
			+ jsonResult);
...
public String  get_employee(@QueryParam("emp_code") String emp_code)
{
	...
	System.out.println("Result returned from get_employee():"
			+ jsonResult);
	System.out.println("**********************************************************************");
...
public String uploadPdfFile(  @FormDataParam("file") InputStream fileInputStream,
                                ...
                                @FormDataParam("id") FormDataContentDisposition project_codefileMetaData) throws Exception
{
...
public String filechange(  @FormDataParam("file") InputStream fileInputStream,
                                ...
                                @FormDataParam("file_descrption") String file_descrprtion
                                ) throws Exception
{
...
JsonObject jsonResult = new JsonObject();
	...
	System.out.println("Result returned from getallcustomer():"
			+ jsonResult);
...
@GET
@Path("/filedownload")
public Response downloadPdfFile(@QueryParam("projectid") final String id,@QueryParam("filename") final String filename)
{
	String file="";
    ...
    StreamingOutput fileStream =  new StreamingOutput() 
    {
        ...
        public void write(java.io.OutputStream output) throws IOException, WebApplicationException 
        {
            try
            {
        		...
        		String alreadypath=rootPath+File.separator+"projectmanagement"+File.separator+"file"+File.separator+id+File.separator+filename;
...
@Path("/filedelete")
    ...
    public String DeleteFile(@QueryParam("projectid") final int id,@QueryParam("filename") final String filename)
    {
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		...
		if (personlist != null
			...
			JsonElement element = gson.toJsonTree(personlist,
					new TypeToken<List<ContactPersonObject>>() {
					}.getType());
	...
	System.out.println("Result returned from get_allcontact_person():"
			+ jsonResult);
...
@Produces(MediaType.APPLICATION_JSON)
public String get_allcontact_person_onproject(@QueryParam("customer_id") int customer_id,
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		...
		personlist=dataHandler.get_allcontact_person_onproject(customer_id,project_id);
...
JsonObject jsonResult = new JsonObject();
	...
	System.out.println("Result returned from one_contact():"
			+ jsonResult);
...
public String contactpersonsave(@FormParam("person_id") List<String> conatctperson
	...
	,@FormParam("project_id") int project_id,@FormParam("contact_id") int customer_id
		)
{
	String errorMessage = "";
...
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
public String contactpersonreupdate(@FormParam("person_id") List<String> conatctperson
...
@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
@Produces(MediaType.APPLICATION_JSON)
public String edit_customer( @FormParam("id") int customer_id,@FormParam("clientcode") String customer_code,
		@FormParam("clientname") String company_name,
		@FormParam("contact_person") String contact_person ,
		@FormParam("phoneno") long contact_phone1,
		@FormParam("areacode") String area_code,
...
public  String contactpersonedit(@FormParam("personname") List<String> personname,
		...
		@FormParam("personno1") List<Long> personno1,	
		@FormParam("personno2") List<Long> personno2,
		@FormParam("customer_id") int customer_id,@FormParam("conatctpersonid") List<Integer> conatctpersonid) throws Exception {
   ...
   System.out.println(personname.size()+" "+personmail.size()+" "+conatctpersonid.size()+" "+personno2.size()+" "+conatctpersonid.size());
	...
	try {
		...
		if (timelist != null
			...
			JsonElement element = gson.toJsonTree(timelist,
					new TypeToken<List<TimeSheetObject>>() {
					}.getType());
...
JsonObject jsonResult = new JsonObject();
	...
	System.out.println("Result returned from get_timesheetview():"
			+ jsonResult);
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		DataHandler dataHandler = new DataHandler(); 		
		allperson=dataHandler.get_timesheetviewadmin(emp_code,start_date,end_date);
		jsonResult.addProperty("status", status);
		jsonResult.addProperty("errorMessage", errorMessage);
		jsonResult.add("object", allperson);
...
@Produces(MediaType.APPLICATION_JSON)
public String get_timesheetall(
		@QueryParam("start_date") String start_date1,
		@QueryParam("end_date") String end_date1,
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		...
		timelist=dataHandler.get_timesheetall(start_date,end_date,project_manager);
...
@Produces(MediaType.APPLICATION_JSON)
public String get_timesheetallview(
		@QueryParam("start_date") String start_date1,
		@QueryParam("end_date") String end_date1,
		@QueryParam("project_manager") String project_manager
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		...
		allperson=dataHandler.get_timesheetallview(start_date,end_date,project_manager);
...
@Produces(MediaType.APPLICATION_JSON)
public String get_timesheetallviewadmin(
		@QueryParam("start_date") String start_date1,
		@QueryParam("end_date") String end_date1,
		@QueryParam("project_manager") String project_manager
...
JsonObject jsonResult = new JsonObject();
	...
	try {
		...
		allperson=dataHandler.get_timesheetallviewadmin(start_date,end_date,project_manager);
...
//@Consumes(MediaType.MULTIPART_FORM_DATA)
@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
public String time_sheet_edit( 
		 @FormParam("rowid") List<Integer> id,
...
//@Consumes(MediaType.MULTIPART_FORM_DATA)
@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
public String timesheetapproved( 
		 @FormParam("emp_code") List<String> emp_code,
...
@Produces(MediaType.APPLICATION_JSON)
public String get_managerdashboard(@QueryParam("project_code") String project_code,@QueryParam("project_manager") String project_manager)
{
JsonObject jsonResult = new JsonObject();
	JsonArray allallocation = null;
	int status = -1;
...
public String managermail(@QueryParam("branch") String branch,
	...
	status = datahandler.managermailsent(branch,manager_code,emp_code,project_code);
...
//@Consumes(MediaType.MULTIPART_FORM_DATA)
//@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
public String resetcodecheck(@QueryParam("emp_code") String emp_code,@QueryParam("newpassword") String newpassword) {
...
public String manager_viewemp(@QueryParam("project_manager") String project_manager)
{
	...
	System.out.println("Result returned from get_manager_emp():"
			+ jsonResult);
	System.out.println("**********************************************************************");
...
public String timesheetapproval(@QueryParam("project_manager") String project_manager)
{
	...
	System.out.println("Result returned from get_timesheet_all():"
			+ jsonResult);
	System.out.println("**********************************************************************");
...
public String designation_get(@QueryParam("Emp_code") String empcode)
{
	...
	System.out.println("Result returned from get_allemployee():"
			+ jsonResult);
	System.out.println("**********************************************************************");
