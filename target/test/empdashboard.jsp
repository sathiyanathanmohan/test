...
//                 out.print("Value: " + cookie.getValue().trim()+" <br/>");
	...
	<table id="mytable" width="1190px" align="center" cellspacing="0"
		...
		<tbody>
			...
			<tr>
				<td><label id="empid"><b>Employee ID:</b></label> <label
					id="empid1"></label> <label id="lempname" style=""><b>Employee
							Name: </b></label> <label id="empname" style=""></label> <label
					id="ldesignation" style=""><b>Designation: </b></label> <label
					id="designation" style=""></label></td>
			</tr>
			...
			<tr>
				<td>
					<div id="nav">
						<p id="title">Employee DashBoard</p>
					</div>
				</td>
			</tr>
