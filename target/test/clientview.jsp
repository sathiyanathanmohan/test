...
<tr>
<td >
<div id="customerdiv" ><p id="customertitle">Client View</p></div>
</td>
</tr>
<tr>
<td >
...
<div >     
  <fieldset Style="border:1px solid black;margin-top:18px;margin-left:25px;width:925px;height:100px">
     <legend><label ><b>Client Details</b></label></legend>
         ...
         <input id="clientcode"  maxlength="30" name="clientcode" type="text" readonly/>
         <label id="clientnamel">Client Name*</label> 
         <input id="clientname" maxlength="30" name="clientname" type="text" readonly/>
       <br>
      
        
        <label id="websitel">Company Website*</label> 
         <input id="website" maxlength="30"  name="website"  type="text" readonly/>
         <label id="phonenol">Phone Number*</label>
       <input id="areacode" maxlength="30" placeholder="areacode" name="areacode" type="text" readonly/> 
        <input id="phoneno" maxlength="30" name="phoneno" type="text" readonly/> 
     </fieldset>
</div>
...
<div >     
    ...
    <label id="address1l">Address Line 1*</label> 
         ...
         <input id="address2" maxlength="30" name="address2" type="text" readonly/>
         <br>
        
        <label id="cityl">City*</label> 
         <input id="city" maxlength="30" name="city" type="text" readonly/>
         <label id="statel">State*</label> 
         <input id="state" maxlength="30"  name="state" type="text" readonly/>
         <br>
        
        <label id="countryl">Country*</label> 
         <input id="country" maxlength="30" name="country" type="text" readonly/>
         <label id="zipcodel">Zip Code*</label> 
         <input id="zipcode" maxlength="30" name="zipcode" type="text" readonly/>
