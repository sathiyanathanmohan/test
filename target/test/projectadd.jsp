...
<link rel="stylesheet" type="text/css"
	href="ProjectManagementTool-UI/css/projectadd.css">
<script
...
<script src="ProjectManagementTool-UI/js/projectadd.js"></script>
<script type="text/javascript">
function goBack() {
    window.history.back();
}
...
//                out.print("Value: " + cookie.getValue().trim()+" <br/>");
      ...
      %>
	<table width="1002px" align="center" cellspacing="0" cellpadding="0">
		<tbody>
			<tr>
				<td>
					<div>
						<h2 id="welcomeuser" ALIGN="left" style="width: 550px;"></h2>
						<button id="logout">
							<B>Log Out</B>
						</button>
						<img id="back"
			...
			<tr>
				<td>
					<div id="projectdiv">
						<p id="projecttitle" Style="color: white">Project Add</p>
					</div>
				</td>
			</tr>
			<tr>
						...
						<form id="form" method="post">
							<div style="margin-right: 2px">
								<fieldset id="projectdetails">
									...
									<label>Project Code* </label> <input id="projectcode"
										...
										id="epc"> Enter project code </label> <br> <label>Project
										Name* </label> <input id="projectname" maxlength="50"
										name="projectname" type="text" /> <label id="epn">Enter
										project name </label> <br> <label>Start Date* </label> <input
										id="startdate" maxlength="20" name="startdate" type="date" />
									<label id="esd"> Select start date</label> <br> <label>End
										Date* </label> <input id="enddate" maxlength="20" name="enddate"
										type="date" /> <label id="eed"> Select end date</label>
							...
							<div style="margin-right: 2px">
								<fieldset id="developementdetails">
									...
									</select> <label id="ec"> Select center</label> <br> <label>Location*</label>
									<select id="location" name="location">
										<option value="Select">Select</option>
									</select> <label id="el"> Select location</label> <br> <label>Contract
										Type*</label> <select id="contracttype" name="contracttype">
										<option value="Select">Select</option>
									</select> <label id="ect">Select contract type</label> <br> <label>Project
										Status*</label> <select id="projectstatus" name="projectstatus">

									</select> <label id="eps">Select project status as open</label> <br>
									<label>Customer Portfolio*</label> <select
										id="customerportfolio" name="customerportfolio">
										<option value="Select">Select</option>
									</select> <label id="ecp">Select customer portfolio</label> <label
										id="servicesl">Services Offered*</label> <select id="services"
										name="services">
										<option value="Select">Select</option>
									</select> <label id="eso">Select services offered</label> <label
										id="techl">Technology*</label> <select id="technology"
										name="technology">
										<option value="">Select</option>

									</select> <label id="et">Select technology</label>
									...
									<label id="effortl">Effort Required*</label> <input
										...
										id="er">Enter effort required</label> <label id="onsitel">Onsite*</label>
									<input id="onsite" name="onsite" maxlength="50" name="name"
										type="text" /> <label id="eon">Enter onsite effort</label> <label
										id="offshorel">offshore*</label> <input id="offshore"
										name="offshore" maxlength="50" name="name" type="text" /> <label
										id="eoff">Enter offshore effort</label>
								</fieldset>
							</div>
							...
							<div style="margin-right: 2px">
								<fieldset id="customerdetails">
									...
									<label>Client Code*</label> <select id="cc" name="customer_id">
										<option value="Select">Select</option>
							...
							<div style="margin-right: 2px; margin-left: 2px">
								<fieldset id="responsibility">
									...
									</select> <label id="epm">Select project manager</label> <label
										id="deliverymanagerl">Delivery Manager*</label> <select
										id="deliverymanager" name="deliverymanager">
										<option value="Select">Select</option>

									</select> <label id="edm">Select delivery manager</label> <label id="">Onsite
										Co-ordinator</label> <select id="onsitecoordinator"
										name="onsitecoordinator">
										<option value="Select">Select</option>

									</select> <label id="eoc">Select onsite co-ordinator</label>
							...
							<div style="margin-right: 2px; position: relative">
								<div>
									<fieldset id="remarks">
										...
										<textarea id="pm" name="pm" rows="4" cols="50"></textarea>
								...
								<div>
									<fieldset id="supportfile">
										...
										<input type="button" value="Attachment upload"
											onclick='onclick1()'> <br> <br> <label
