				...
				<td>
					<div>
						<h2 id="welcomeuser" align="left"
							style="margin-top: 40px; margin-left: 0px; width: 550px;"></h2>
						<button id="logout" style="margin-left: 873px; margin-top: 40px;">
							<b>Log Out</b>
						</button>
			...
			<tr>
				<td>
					<div id="projectdiv" style="margin-top: 0px;">
						<div id="menutab">
							<img id="menuicon"
								src="ProjectManagementTool-UI/css/images1/10.jpg">
							<nav id="menu">
							<ul class="parent-menu">
								...
								<li><a href="#">Client
										...
										></a>
									<ul style="margin-top: 40px; height: 80px">
										<li><a href="clientadd.jsp">Client Add</a></li>
										<li><a href="clientdashborad.jsp">Client View</a></li>
									</ul></li>
								<li><a href="#">Employee
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										></a>
									<ul style="margin-top: 80px; height: 80px">
										<li><a href="EmployeeAdd.jsp">Employee Add</a></li>
										<li><a href="EmployeeEdit.jsp">Employee Edit</a></li>
									</ul></li>
								<li><a href="#">Timesheet
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										></a>
									<ul style="margin-top: 120px; height: 80px">
										<li><a href="managerviewemp.html">Timesheet Approved</a></li>
					...
					<p id="projecttitle" style="color: white; margin-top: 15px;">Project
						List</p>
					</div>
				</td>
			</tr>
